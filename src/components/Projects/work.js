...
export default function work({ title, desc, tags, link, code, img, descOpt }) {
  return (
    <Tilt
      options={{
        max: 45,
      ...
      <div className="bg-[#0b212d] w-full h-full rounded-2xl p-4 flex flex-col justify-between">
        <div>
          <div className="relative w-full rounded-2xl">
            ...
            <div className="absolute inset-0 flex justify-end m-3 ">
              <div
                ...
                className="bg-slate-800 w-11 h-11 rounded-full border-[1px] border-secondary flex items-center justify-center cursor-pointer mr-2"
              >
                <img
              ...
              <div
                ...
                className="bg-slate-800 w-11 h-11 rounded-full border-[1px] border-secondary flex items-center justify-center cursor-pointer "
              >
                <img
          ...
          <div className="mt-5">
            ...
            {
              descOpt ? (
                  <ul className="mt-2 text-secondary text-[14px]">{descOpt.map((opt, idx) => {
